...
public class AttractionAiPlanService {
    ...
    public List<DayPlanDto> generateSeasonPlan(String season) {
        try {
            Message userMessage = aiPromptService.createSeasonUserMessage(season);
            Message systemMessage = aiPromptService.createSeasonSystemMessage();
