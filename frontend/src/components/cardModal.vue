  ...
  <Teleport to="body">
    <div v-if="card" class="modal-overlay" @click.self="$emit('close')">
      <div class="modal-container">
        <div
          :class="['card-content', { flipped: flipped }]"
        ...
        >
          <div class="card-inner" :style="cardStyle">
            ...
            <div class="card-back">
              <img
                src="https://enjoy-trip-static-files.s3.ap-northeast-2.amazonaws.com/card_back.png"
                alt="Card Back"
                class="card-image"
              />
            </div>
        ...
        <!-- 마이페이지에서 열었을 때는 카드도감 버튼 숨기기 -->
        <router-link
          v-if="!isFromMyPage"
          to="/mypage/card"
          class="cardbook-button"
      ...
      <!-- 마이페이지에서 열었을 때는 콘페티 효과 제외 -->
      <div v-if="!isFromMyPage" class="confetti-container">
...
.card__glare {
  ...
  background: radial-gradient(
    farthest-corner circle at v-bind('springGlare.x + "%"') v-bind('springGlare.y + "%"'),
