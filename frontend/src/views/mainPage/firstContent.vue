  ...
  <section class="first-section">
    ...
    <content-box class="photo-grid">
      <div class="first-box1">
        ...
        <button>살펴보러가기</button>
      </div>
      <div class="first-box2">
        <img
          src="@/assets/image/photo1.png"
        />
      </div>
      <div class="first-box3">
        <img
          src="@/assets/image/photo2.png"
        />
      </div>
      <div class="first-box4">
        <img
          src="@/assets/image/photo3.png"
        />
      </div>
    </content-box>
  </section>
...
.first-box1 button:hover{
  transform: scale(1.05);
  background-color: #ffdd57;
}

.first-box2 {
  grid-column: 2 / 3; /* 2번째 열에서 시작하여 3번째 열에서 끝남 */
  grid-row: 1 / 2; /* 1번째 행에서 시작하여 2번째 행에서 끝남 */
}
