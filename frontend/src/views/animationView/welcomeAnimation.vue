...
<template>
  <div class="animation-container">
    ...
    <div class="criterion">
      <div class="text text0">T</div>
      <div class="text text1">R</div>
      <div class="text text2">I</div>
      <div class="text text3">P</div>
      <div class="text text4">M</div>
      <div class="text text5">O</div>
      <div class="text text6">C</div>
      <div class="text text7"><i class="fa-solid fa-plane-up"></i></div>
      ...
      <div v-for="i in 12" :key="`p0${i-1}`" :class="`particle particle0${i-1}`"></div>
      <div v-for="i in 12" :key="`p1${i-1}`" :class="`particle particle1${i-1}`"></div>
      <div v-for="i in 12" :key="`p2${i-1}`" :class="`particle particle2${i-1}`"></div>
      <div v-for="i in 12" :key="`p3${i-1}`" :class="`particle particle3${i-1}`"></div>
      <div v-for="i in 12" :key="`p4${i-1}`" :class="`particle particle4${i-1}`"></div>
      <div v-for="i in 12" :key="`p5${i-1}`" :class="`particle particle5${i-1}`"></div>
      <div v-for="i in 12" :key="`p6${i-1}`" :class="`particle particle6${i-1}`"></div>
      <div v-for="i in 12" :key="`p7${i-1}`" :class="`particle particle7${i-1}`"></div>
    </div>
  </div>
</template>
